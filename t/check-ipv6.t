...
subtest "cf-connecting-ip" => sub {
    my $tx = $t->ua->build_tx(GET => '/' => {'cf-connecting-ip' => '1.2.3.4', 'true-client-ip' => '2400:cb00:f00d:dead:beef:1111:2222:3333'});
    $t->request_ok($tx)->content_is('2400:cb00:f00d:dead:beef:1111:2222:3333');
};

subtest "ignore rfc-7239 ipv4" => sub {
    my $tx = $t->ua->build_tx(GET => '/' => {'forwarded' => 'for=2.2.2.2', 'x-forwarded-for' => '2400:cb00:f00d:dead:beef:1111:2222:3333'});
    $t->request_ok($tx)->content_is('2400:cb00:f00d:dead:beef:1111:2222:3333');
};
